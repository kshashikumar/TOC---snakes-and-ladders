...
public class Main extends JFrame {
	...
	private int[] flag= new int[6];   // flag 1 Then every player will start the game
	//private int[] location= new int[2];  // 2 players will have locations.
	private int[] playerposition= new int[4]; //4 players is position
	private int oldposition;   //Player's previous position. Because I have to delete the previous position
	...
	private int chokkarAaagerPosition=0,playerItem=0;
	/**
	...
	public void movedisc(){
		...
		//----------------playerItem uthle count baraitesi ar na uthle count 0---------//
		if(point==6)playerItem++;
        else playerItem=0;
		...
		//------------3bar playerItem uthle ager ghore pathaye dibe-------------//
	...
	public Main() {
		setTitle("TOC - Snakes and Ladders game");          //constructor
		FrameinMiddle();
	...
	public void initialize(){    //game board er label, ghorer label and other label gula shob initialize kortesi
		...
		contentPane.add(lblPlayerName);
		 ...
		 btnDice.addActionListener(new ActionListener() {
		 	public void actionPerformed(ActionEvent e) {
		 		...
		 		Dice();                           //say the method call of course
		 		if(playerItem==0)
		 		{
		 			player++;                    //If 1 person clicks the dice... another person will click the dice
		 		    if(player==5)player=1; 
		 		}// Because my game has 4 players so.. :/ :/
		...
		//The work of the lower part is to press the enter button so that the button works.
